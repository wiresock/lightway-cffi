//! ExpressLane data-packet encrypt/decrypt primitives.
//!
...
//! `lightway-core`, using `ring`'s AES-256-GCM instead of wolfssl. See `docs/superpowers/specs/2026-07-16-expresslane-data-cffi-design.md`
